...
void main(void)
{
    ...
    strncpy(cad2, cad0, 4);
    cad2[4] = '\0';
    printf("\nPrueba de la funcion strcpy. Se copia 4 caracteres de cad0 a cad: %s\n", cad2);

    strcat(cad0, cad3);
    cad2[3] = '\0';
    printf("\nPrueba de la funcion strncpy. Se copia 3 caracteres de cad3 a cad0: %s\n", cad0);
    ...
    printf("\nPrueba de la funcion ststr. Se trata de localizar la cadena Guatemala dentro de cad0: %s\n", cad0);
